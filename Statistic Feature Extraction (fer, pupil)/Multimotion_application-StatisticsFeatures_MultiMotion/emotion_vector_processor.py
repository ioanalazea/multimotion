...
class EmotionVectorProcessor:
    ...
    def process_emotions(self, emotion_data):
        ...
        # Iterate through the emotion data and compute the emotion vectors - weighted emotions method
        for row in emotion_data.values:
            ...
            # Add the valence and arousal values to lists
    ...
    # Function to process the emotion data for each stimulus - path variant
